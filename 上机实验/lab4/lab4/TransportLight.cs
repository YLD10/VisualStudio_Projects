    ...
    public partial class TransportLight : Form
    {
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                pbUpTurnLeft.Image = ilAll.Images[5];
                pbUpStraight1.Image = pbUpStraight2.Image = ilAll.Images[7];
                labUp.ForeColor = Color.Red;
                labUp.Text = (100 + i).ToString().Substring(1, 2);

                pbDownTurnLeft.Image = ilAll.Images[9];
                pbDownStraight1.Image = pbDownStraight2.Image = ilAll.Images[1];
                labDown.ForeColor = Color.Red;
                labDown.Text = (100 + i).ToString().Substring(1, 2);

                if (i > 13)
                {
                    pbLeftTurnLeft.Image = ilAll.Images[1];
                    pbLeftStraight1.Image = pbLeftStraight2.Image = ilAll.Images[4];
                    labLeft.ForeColor = Color.Green;
                    labLeft.Text = (100 + i - 13).ToString().Substring(1, 2);

                    pbRightTurnLeft.Image = ilAll.Images[7];
                    pbRightStraight1.Image = pbRightStraight2.Image = ilAll.Images[8];
                    labRight.ForeColor = Color.Green;
                    labRight.Text = (100 + i - 13).ToString().Substring(1, 2);
                }
                else
                {
                    if (i > 10)
                    {
                        pbLeftTurnLeft.Image = ilAll.Images[1];
                        pbLeftStraight1.Image = pbLeftStraight2.Image = ilAll.Images[6];
                        labLeft.ForeColor = Color.Yellow;
                        labLeft.Text = (100 + i - 10).ToString().Substring(1, 2);

                        pbRightTurnLeft.Image = ilAll.Images[7];
                        pbRightStraight1.Image = pbRightStraight2.Image = ilAll.Images[10];
                        labRight.ForeColor = Color.Yellow;
                        labRight.Text = (100 + i- 10).ToString().Substring(1, 2);
                    }
                }
                ...
                if (i <= 10)
                {
                    if (i > 3)
                    {
                        pbLeftTurnLeft.Image = ilAll.Images[0];
                        pbLeftStraight1.Image = pbLeftStraight2.Image = ilAll.Images[5];
                        labLeft.ForeColor = Color.Green;
                        labLeft.Text = (100 + i - 3).ToString().Substring(1, 2);

                        pbRightTurnLeft.Image = ilAll.Images[3];
                        pbRightStraight1.Image = pbRightStraight2.Image = ilAll.Images[9];
                        labRight.ForeColor = Color.Green;
                        labRight.Text = (100 + i - 3).ToString().Substring(1, 2);
                    }
                    else
                    {
                        pbLeftTurnLeft.Image = ilAll.Images[2];
                        pbLeftStraight1.Image = pbLeftStraight2.Image = ilAll.Images[5];
                        labLeft.ForeColor = Color.Yellow;
                        labLeft.Text = (100 + i).ToString().Substring(1, 2);

                        pbRightTurnLeft.Image = ilAll.Images[12];
                        pbRightStraight1.Image = pbRightStraight2.Image = ilAll.Images[9];
                        labRight.ForeColor = Color.Yellow;
                        labRight.Text = (100 + i).ToString().Substring(1, 2);
                    }
                }
            }
            -- i;
